...
> ⚠️ Помните, что вам необходимо постоянно следить за обновлениями, которые публикуются в нашем [Discord](https://discord.gg/ExordeLabs) на канале #testnet. Если вышло обновление, но вы его проигнорируете, вы можете просто впустую потратить ресурсы (время; вычислительные мощности; средства, если используете арендованный vps, и т.п.). 
