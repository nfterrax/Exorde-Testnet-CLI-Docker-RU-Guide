...
> ⚠️ ВНИМАНИЕ! ИМЕЙТЕ В ВИДУ, ЧТО ДВЕ ПЕРВЫЕ КОМАНДЫ ОЧИСТЯТ ВСЕ КОНТЕЙНЕРЫ И ОБРАЗЫ НА ВАШЕМ СЕРВЕРЕ! ПОЭТОМУ ЕСЛИ НА ВАШЕМ СЕРВЕРЕ ЗАПУЩЕНЫ ДРУГИЕ ПРОЦЕССЫ КРОМЕ EXORDE, ВАМ ЛУЧШЕ УДАЛЯТЬ КАЖДЫЙ EXORDE МОДУЛЬ И ЕГО ОБРАЗЫ ПО ОТДЕЛЬНОСТИ!
